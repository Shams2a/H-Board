  ...
  return (
    <div className="relative w-full">
      <div
        ...
        className="flex flex-wrap items-center gap-1 px-2 py-1 text-sm cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded min-h-[28px]"
      >
        {selectedOptions.length > 0 ? (
          selectedOptions.map((option) => (
            <div
              key={option.id}
              className="inline-flex items-center gap-1.5 px-2 py-1 rounded bg-gray-100 dark:bg-gray-700"
            >
              ...
              <button
                ...
                className="hover:bg-gray-200 dark:hover:bg-gray-600 rounded p-0.5 flex-shrink-0"
                title="Remove"
              >
