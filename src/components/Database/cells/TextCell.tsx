...
export default function TextCell({ value, onChange, isTitle = false }: TextCellProps) {
  ...
  return (
    <div
      ...
      className={`w-full px-2 py-1 text-sm cursor-text hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded min-h-[28px] ${
        isTitle && !value ? 'text-gray-400 dark:text-gray-500 italic' : 'text-gray-900 dark:text-gray-100'
      }`}
    >
