...
export default function BoardEditModal({ board, isOpen, onClose }: BoardEditModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-[#1E252B] rounded-lg w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-auto px-6 py-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 border border-gray-300 dark:border-[#3D444D] bg-white dark:bg-[#252B32] text-gray-900 dark:text-[#E0E6ED] rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 resize-none"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              ...
              {tags.length === 0 && (
                <p className="text-sm text-gray-500 dark:text-[#B1B9C4]">Aucun tag</p>
              )}
            </div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-300 dark:border-[#3D444D] bg-white dark:bg-[#252B32] text-gray-900 dark:text-[#E0E6ED] rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 text-sm"
              />
              <button
        ...
        {/* Footer */}
        <div className="flex justify-end gap-3 px-6 py-4 border-t border-gray-200 dark:border-[#30363D] bg-gray-50 dark:bg-[#252B32]/50">
          <button
            onClick={onClose}
            className="px-4 py-2 text-gray-700 dark:text-[#E0E6ED] hover:bg-gray-100 dark:hover:bg-[#252B32] rounded-lg transition-colors"
          >
            Annuler
          </button>
          <button
